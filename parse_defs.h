...
/**
 * @brief 描述一个alter table add column语句
 * @ingroup SQLParser
 */
struct AlterTableAddColumnSqlNode
{
  string          relation_name;  ///< 要修改的表名
  AttrInfoSqlNode attr_info;      ///< 新增的列定义
};
...
public:
  ...
  AlterTableAddColumnSqlNode alter_table;
