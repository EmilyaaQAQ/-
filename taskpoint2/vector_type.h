...
public:
   ...
   * @brief 向量距离计算方法
   */
  static RC cosine_distance(const Value &v1, const Value &v2, float &result);
  static RC dot_product(const Value &v1, const Value &v2, float &result);
  static RC euclidean_distance(const Value &v1, const Value &v2, float &result);
};